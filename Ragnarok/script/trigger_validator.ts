module validator {
	...
	//$$ragnarok_xanb.item.一级兵营.SpellBuild:Data.Game.Formulas.Mana
	...
	//$$ragnarok_xanb.unit.一级兵营.Spell:Data.Game.Formulas.Mana
	/** @noSelf */
	...
	//$$ragnarok_xanb.item.一级兵营.SpellBuild:Data.Game.Formulas.Cooldown
	...
	//$$ragnarok_xanb.unit.一级兵营.Spell:Data.Game.Formulas.Cooldown
	/** @noSelf */
	...
	//$$ragnarok_xanb.item.一级兵营.SpellBuild:Data.Game.Formulas.ChargeMax
	...
	//$$ragnarok_xanb.unit.一级兵种.Spell:Data.Game.Formulas.ChargeMax
	//$$ragnarok_xanb.unit.一级兵营.Spell:Data.Game.Formulas.ChargeMax
	/** @noSelf */
	...
	//$$ragnarok_xanb.item.一级兵营.SpellBuild:Data.Game.Formulas.Range
	...
	//$$ragnarok_xanb.unit.一级兵种.Spell:Data.Game.Formulas.Range
	//$$ragnarok_xanb.unit.一级兵营.Spell:Data.Game.Formulas.Range
	/** @noSelf */
	...
	//$$ragnarok_xanb.item.一级兵营.SpellBuild:Data.Game.Formulas.Time
	...
	//$$ragnarok_xanb.unit.一级兵营.Spell:Data.Game.Formulas.Time
	/** @noSelf */
	...
	export let validator_153069034:(this: void, 效果节点:EffectParam)=>boolean = (this: void, 效果节点:EffectParam):boolean => {
		...
		switch (所属玩家) {
			case base.player(1): {
				log.warn("不能生成语句: 未找到元素：[TRG_ENV: server, packageName: ragnarok_xanb, id: CustomEvent:初始化镜头:3165293876:Constructor]")
				base.player(1).get_hero().remove();
				base.player(1).set_hero(效果节点.target.get_unit());
				smallcard_unit_attr_panel.绑定玩家全部单位属性面板为单位(base.player(1), 效果节点.target.get_unit());
				if (((所属队伍 == 1))) {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点1", _G.present));
				} else {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点2", _G.present));
				}
				break;
			}
			case base.player(2): {
				base.player(2).get_hero().remove();
				base.player(2).set_hero(效果节点.target.get_unit());
				smallcard_unit_attr_panel.绑定玩家全部单位属性面板为单位(base.player(2), 效果节点.target.get_unit());
				if (((所属队伍 == 1))) {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点1", _G.present));
				} else {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点2", _G.present));
			...
			case base.player(3): {
				base.player(3).get_hero().remove();
				base.player(3).set_hero(效果节点.target.get_unit());
				smallcard_unit_attr_panel.绑定玩家全部单位属性面板为单位(base.player(3), 效果节点.target.get_unit());
				if (((所属队伍 == 1))) {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点1", _G.present));
				} else {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点2", _G.present));
			...
			case base.player(4): {
				base.player(4).get_hero().remove();
				base.player(4).set_hero(效果节点.target.get_unit());
				smallcard_unit_attr_panel.绑定玩家全部单位属性面板为单位(base.player(4), 效果节点.target.get_unit());
				if (((所属队伍 == 1))) {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点1", _G.present));
				} else {
					效果节点.target.get_unit().blink_ex(base.get_scene_point("default", "出生点2", _G.present));
	...
	//$$ragnarok_xanb.unit.一级兵种.Damage_1:Data.Game.Amount
	/** @noSelf */
	...
	//$$ragnarok_xanb.unit.一级兵种.Spell:Data.Game.Formulas.Mana
	/** @noSelf */
	...
	//$$ragnarok_xanb.unit.一级兵种.Spell:Data.Game.Formulas.Cooldown
	/** @noSelf */
	...
	//$$ragnarok_xanb.unit.一级兵种.Spell:Data.Game.Formulas.Time
	/** @noSelf */
	...
	export let validator_51017330:(this: void, 效果节点:EffectParam)=>boolean = (this: void, 效果节点:EffectParam):boolean => {
		...
		if (((效果节点.target.get_unit().get_owner().get_team_id() == 1))) {
			...
			lib_common_ai.unit_ai_attack_move_to(效果节点.target.get_unit(), base.get_scene_line("default", "西方进攻路线", _G.present), false, 500);
		} else {
			效果节点.target.get_unit().blink_ex(base.get_scene_area("default", "rect", "东方聚集点", _G.present).scene_random_point());
			lib_common_ai.unit_ai_attack_move_to(效果节点.target.get_unit(), base.get_scene_line("default", "东方进攻路线", _G.present), false, 500);
		}
		return result;
	}
	...
	function init_validator_0() {
		...
		if (data = base.eff.cache("$$ragnarok_xanb.item.一级兵营.SpellBuild")) {
			data.Formulas.Mana = validator_244194926
			data.Formulas.Cooldown = validator_135839809
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$ragnarok_xanb.unit.一级兵营.Spell")) {
			data.Formulas.Mana = validator_244194926
			data.Formulas.Cooldown = validator_135839809
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$ragnarok_xanb.unit.一级兵种.Spell")) {
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
			data.Formulas.Mana = validator_33587127
			data.Formulas.Cooldown = validator_214974897
		...
		if (data = base.eff.cache("$$ragnarok_xanb.unit.一级兵种.Damage_1")) {
			data.Amount = validator_196209676
		}
